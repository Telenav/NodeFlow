...
public class LocationFlow extends NodeFlow {
    ...
    protected Node<?> getRootNode() {
        return new Node<>(new Location("root")).addChildNodes(Arrays.asList(
                new Node<>(new Location("Asia").setIconResourceId(R.drawable.ic_directions_transit_white_36dp)),
                new Node<>(new Location("Europe").setIconResourceId(R.drawable.ic_directions_car_white_36dp)).addChildNodes(Arrays.asList(
                        new Node<>(new Location("Austria").setIconResourceId(R.drawable.ic_directions_car_white_36dp)).addChildren(Arrays.asList(
                        ...
                        new Node<>(new Location("Belgium").setIconResourceId(R.drawable.ic_directions_car_white_36dp)).addChildren(Arrays.asList(
                ...
                new Node<>(new Location("North America").setIconResourceId(R.drawable.ic_directions_boat_white_36dp)).addChildNodes(Arrays.asList(
                        new Node<>(new Location("United States").setIconResourceId(R.drawable.ic_directions_boat_white_36dp)).addChildren(Arrays.asList(
                        ...
                        new Node<>(new Location("Mexico").setIconResourceId(R.drawable.ic_directions_boat_white_36dp)).addChildren(Arrays.asList(
    ...
    @Override
    public View getContentView(Node<?> node) {
